...
// ==================================================
#define CONFIG_AP_SSID   "DeskBuddy" 
#define CONFIG_AP_PASS   "123456789"
...
void handleConfigRoot() {
  ...
  String sApik = prefs.getString("apikey", "Enter api key");
  String sCity = prefs.getString("city", "pune");
...
void handleConfigSave() {
  ...
  prefs.begin("deskbuddy", true);
  if (ak.isEmpty())  ak  = prefs.getString("apikey", "Enter api key");
  if (cty.isEmpty()) cty = prefs.getString("city", "pune");
